 ...
 constructor(
   ...
   async initialize(): Promise<void> {
     ...
     try {
       ...
       if (this.client) {
         ...
         // This allows publishObjectState / publishHomeAssistantState to run during initialization.
         this.isReady = true;
   ...
   private async publishHomeAssistantState(serial: string): Promise<void> {
     ...
     try {
       ...
       console.log(`[MQTT:${this.userId}] Fan mode for ${serial}: ${fanMode} (timer_timeout: ${device.fan_timer_timeout}, control_state: ${device.fan_control_state}, hvac_fan: ${shared.hvac_fan_st[...]
